...
const Home = () => {
  ...
  const featuredAuctions = [
    { id: 1, title: 'Auction Item 1', description: 'Description 1', image: '/ey-gds-task1/pexels1.jpg' },
    { id: 2, title: 'Auction Item 2', description: 'Description 2', image: '/ey-gds-task1/pexels2.jpg' },
    { id: 3, title: 'Auction Item 3', description: 'Description 3', image: '/ey-gds-task1/pexels3.jpg' },
  ];
